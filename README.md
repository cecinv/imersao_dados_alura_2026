# Imersão Alura – Ciência de Dados

Repositório com os notebooks desenvolvidos durante a Imersão da Alura.

## Estrutura
- Os notebooks refletem os exercícios e experimentações feitas durante as aulas
...
- **Aula 02 – Limpeza dos dados**  
  Tratamento de valores nulos, ajustes de tipos de dados e geração de um dataset limpo
  para continuidade das análises.
...
## Link para o Dashboard: https://imersaodadosalura2026.streamlit.app/
